		...
		<div>
			...
			<motion.div
			  variants={list}
				initial="hidden"
				animate="show"
			  transition={{ ease: "easeOut", duration: 3,delay: 0.8 }}
			  >
			  ...
			  variants={list}
				initial="hidden"
				animate="show"
			  transition={{ ease: "easeOut", duration: 3,delay: 1.1 }}
			  >
				<div className={classes.line1}></div></motion.div>

				<motion.div
			  variants={list}
				initial="hidden"
				animate="show"
			  transition={{ ease: "easeOut", duration: 3,delay: 1.4 }}
			  >
